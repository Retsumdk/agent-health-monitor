...
program.name("agent-health-monitor").description("Real-time agent health monitoring with heartbeat detection, failure alerts, automatic restart, and comprehensive status dashboards").version("1.0.0")
